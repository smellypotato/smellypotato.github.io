...
let className = `${query.get("paper")}a5hl`;
let textArr = fullString.split(",");
let rowArr = [];
let rowOffset = [];

let table = document.getElementById("top");
document.getElementsByClassName("a5hl")[1].className = className;
document.getElementsByClassName("a5hl")[0].className = className;
